...
namespace MirrorSharp.Internal.Reflection {
    internal class SignatureHelpProviderWrapper : ISignatureHelpProviderWrapper {
        ...
        private static readonly Func<object, Document, int, SignatureHelpTriggerInfoData, CancellationToken, Task> _getItemsAsyncWithUntypedResult = CompileGetItemsAsyncWithUntypedResult();
